...
class ScrapeProductMedia {
	 ...
	 * to the copy in class-fetchimportproductimagecommand.php (issue #110). The
	 * pipeline's CI asserts its file is a superset of both copies, so a hash
	 * added only here fails that repository's gates.
