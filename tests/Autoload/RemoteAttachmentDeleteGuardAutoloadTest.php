<?php
/**
 * Autoload-time registration test for RemoteAttachmentDeleteGuard.
 *
 * @package FA-Toolkit
 */
 ...
 */
class RemoteAttachmentDeleteGuardAutoloadTest extends TestCase {

	use AssertsNoAutoloadRegistration;

	/**
	 * Loading the class file must not register the delete filter.
	 *
	 * @return void
	 */
	...
	public function test_loading_the_class_file_registers_nothing() {
		$this->assertAutoloadRegistersNoHooks(
			'FAToolkit\Media\RemoteAttachmentDeleteGuard',
