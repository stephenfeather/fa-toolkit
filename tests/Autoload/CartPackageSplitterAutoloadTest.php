<?php
/**
 * Autoload-time registration test for CartPackageSplitter.
 *
 * @package FA-Toolkit
 */
 ...
 */
class CartPackageSplitterAutoloadTest extends TestCase {

	use AssertsNoAutoloadRegistration;

	/**
	 * Loading the class file must not register the shipping hook.
	 *
	 * @return void
	 */
	...
	public function test_loading_the_class_file_registers_nothing() {
		$this->assertAutoloadRegistersNoHooks(
			'FAToolkit\Shipping\CartPackageSplitter',
			'fa-toolkit.php (Shipping section)'
		);
	}
}
