<?php
/**
 * Autoload-time registration test for AfterImportAttributes.
 *
 * @package FA-Toolkit
 */
 ...
 */
class AfterImportAttributesAutoloadTest extends TestCase {
	...
	public function test_loading_the_class_file_registers_nothing() {
		$this->assertAutoloadRegistersNoHooks(
			'FAToolkit\Attributes\AfterImportAttributes',
			'fa-toolkit.php (Attributes section)'
		);
	}
}
